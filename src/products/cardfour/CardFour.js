                    ...
                    <thead>
                      <tr>
                        <th className="text-left">
                          Total Product: {totals.totalProducts}
                        </th>
                        <th className="text-left">
                          Net Rate Total : {totals.overallTotal.toFixed(2)}
                        </th>
                        <th className="text-left">
                          Discount with Total: {totals.discountRate.toFixed(2)}
                        </th>
                        <th
                          className="text-left cart-four"
                  ...
                  <Table responsive className="mb-0 fourth-table">
                    ...
                    <tbody>
                      {category.map((categoryItem) => {
                        ...
                        if (filteredProducts.length === 0) return null; // hide category if no product matches
                          ...
                          <React.Fragment key={categoryItem.id}>
                            ...
                            {filteredProducts.map((product) => (
                              ...
                              >
                                ...
                                <td>
                                  <div className="cardfour-product-name">
                                    {product.product_name}
                                  </div>
                                </td>
                                ...
                                <td>
                                  <div className="netrate">{product.price}</div>
